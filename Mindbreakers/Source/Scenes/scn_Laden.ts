namespace Template {
    export async function scn_Laden():ƒS.SceneReturn {
      ...
      await ƒS.update(1);
      await ƒS.Speech.tell(characters.narrator, "Das ist sehr ungünstig. Was soll ich jetzt nur tun?");
      await ƒS.update(1);
