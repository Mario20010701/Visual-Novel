namespace Template {
    export async function scn_MBGF(): ƒS.SceneReturn {
        await ƒS.Speech.hide();
        await ƒS.Character.hideAll();
        await ƒS.update(0.1);
        await ƒS.Location.show(backgrounds.BG_MBGFinCage);
        await ƒS.update(0.3);
        ...
        await ƒS.Location.show(backgrounds.BG_MBCagedown);
        await ƒS.update(0.1);
        ...
        switch (gfgf) {
            case erinnern.Ja:
                ...
                await ƒS.update(0.2);
                await ƒS.Speech.tell(characters.Alice, "Phh... Ich warte mal dort hinten.");
                await ƒS.update(0.2);
