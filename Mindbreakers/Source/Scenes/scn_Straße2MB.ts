namespace Template {
  export async function scn_Straße2MB(): ƒS.SceneReturn {
    await ƒS.update(0.1);
    await ƒS.Speech.tell(characters.Alice, "Es wird bald anfangen zu wirken.");
    await ƒS.update(1);
    ...
    switch (Hammerbreakersintus) {
      ...
      case gehen.No:
        ...
        await ƒS.update(0.5);
        ƒS.Sound.play(sound.gunshots, 1, false);
        await ƒS.update(1);
